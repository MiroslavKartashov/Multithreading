...
public class MainClass {
    ...
    private void methodOne(){
        ...
        System.out.println(String.format("Конец метода 1. Время выполнения %s", String.valueOf(end - start)));
    }
    ...
    private void methodTwo(){
        ...
        System.arraycopy(arr2, 0, arr, h, h);
        long end = System.currentTimeMillis();
        System.out.println(String.format("Время выполнния спайка массива %s", String.valueOf(end - connect)));
        System.out.println(String.format("Конец метода 2. Время выполнения %s", String.valueOf(end - start)));
    }
